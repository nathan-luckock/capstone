...
| WAL-logged catalog: schema changes are logged and replayed on open, so the log is authoritative for the schema and forward replay reconstructs later schema changes | **done** |
